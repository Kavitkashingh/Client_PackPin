    ...
    return (
        ...
        <div>
                ...
                <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                    <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                        <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                            <h2 className='text-3xl font-bold'>PackPin</h2>
            ...
            <section className='py-16'>
                <div className='w-[95%] md:w-[90%%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    ...
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-2/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0 '}`}>
                        {/* justify-center xs:gap-0 gap-5 rounded-3xl xs:w-full grid grid-cols-5 sm:grid-cols-2 xs:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 md-lg:grid-cols-2 2xl:grid-cols-4 */}
                        ...
                        <div className='w-10/12 md-lg:w-8/12 md:w-full'>
