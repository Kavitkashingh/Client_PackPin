...
const Details = () => {
    ...
    return (
        <div >
            ...
            <section className='xs:pt-20'>
                <div className='w-[85%] xs:w-[95%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16'>
                    <div className='grid grid-cols-2 md-lg:grid-cols-1   gap-8'>
                        <div className=' ml-8'>
                            <div className='p-5 xs:p-0 border items-center'>
                        ...
                        <div className='flex flex-col gap-5'>
                            <div className='text-3xl xs:text-xl  text-slate-600 flex gap-6 font-bold'>
                                <h2>{product.name}</h2>
                            ...
                            <div className='text-2xl w-[100%] text-red-500 font-bold flex gap-3'>
                                {
                                    product.discount !== 0 ? <>
                            ...
                            <div className='flex py-5 gap-3'>
                                ...
                                <div className='flex xs:flex-col  gap-3 '>
                                    ...
                                    {
                                        product.stock ? <>
                                            <div className='flex bg-slate-200 xs:w-[170px] h-[50px] rounded-xl justify-center items-center text-xl border-solid border-2 border-red-500'>
                            ...
                            <div className='flex xs:flex-col gap-3 w-full'>
                                {
...
//                                         {
//                                             product.stock ? <>
//                                                 <div className='flex bg-slate-200 h-[50px] rounded-xl justify-center items-center text-xl border-solid border-2 border-red-500'>
