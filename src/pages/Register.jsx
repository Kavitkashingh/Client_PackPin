    ...
    return (
        <div>
            ...
            <div className='bg-slate-200'>
                <div className='w-full justify-center xs:py-16  items-center xs:p-0 p-10'>
                    <div className='grid grid-cols xs:w-[350px] xs:h-[580px] w-[540px] h-[631px] mx-auto bg-white rounded-3xl'>
                        <div className='xs:px-3  px-[60px] py-[10px]'>
                        {/* <div className='h-[36px] w-[36px] ml-[200px] m-10 bg-[#FF5A5A] text-center rounded-full'></div> */}
                            <h2 className='text-center w-full text-[29px] font-bold'>Create an account</h2>
                            <div>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p>You have no account ? <Link className='text-red-500 font-bold ' to='/login'>Login</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
