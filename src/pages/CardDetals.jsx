...
const Details = () => {
    ...
    return (
        <div className='h-[100vh] w-[65%] bg-white p-2'>
            <div className=' xs:w-[100%] w-full md:w-[80%] sm:w-[90%] lg:w-[90%] h-[170px] pb-16'>
                <div className='w-[100%] flex gap-2'>

                    <div className='border rounded-lg items-center'>
                        <img className='rounded-lg' src={image ? image : product.images?.[0]} alt="" />
                    </div>

                    <div className='flex flex-col mt-5 h-[170px] w-[400px]'>
                        <div className='text-xl xs:text-sm text-slate-600 gap-4 font-bold'>
                            <h2>{product.name}</h2>
                            <div className='just ify-start items-center gap-2'>
                                <div className='flex'>
                        ...
                        <div className='text-xl text-red-500 font-bold flex gap-3'>
                            {
                                product.discount !== 0 ? <>
            ...
            <div className='flex flex-col py-5 gap-3 xs:mt-10'>
                ...
                <div className='flex xs:flex-col  gap-3 '>
                    ...
                    {
                        product.stock ? <>
                            <div className='flex bg-slate-200 xs:w-[240px] h-[50px] rounded-xl justify-center items-center text-xl border-solid border-2 border-red-500'>
...
//     }
//     return (
//         <div className='h-[100vh] w-[80%] ml-[24%] bg-white p-5'>
//             <div className='w-full md:w-[80%] sm:w-[90%] lg:w-[90%] h-[170px] pb-16'>
//                 <div className=' flex gap-4'>

//                     <div className='border rounded-lg h-[140px] w-[144px] items-center'>
//                         <img className='border rounded-lg'  src={image ? image : product.images?.[0]} alt="" />
//                     </div>

//                     <div className='flex flex-col mt-5 h-[170px] w-[400px]'>
//                         <div className='text-xl text-slate-600 flex gap-4 font-bold'>
//                             <h2>{product.name}</h2>
