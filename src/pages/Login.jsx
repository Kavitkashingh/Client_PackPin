    ...
    return (
        <div>
            ...
            <div className='bg-slate-200 h-[100vh]'>
                <div className='w-full justify-center xs:pt-20 items-center xs:p-0 p-10'>

                    <div className='grid grid-cols xs:w-[350px] w-[540px] xs:h-[530px]  h-[631px] mx-auto bg-white rounded-3xl '>
                        <div className=' xs:px-3 xs:py-0 px-[60px] py-[10px]'>
                            {/* <div className='h-[36px] w-[36px] xs:ml-[150px] ml-[200px] m-10 bg-[#FF5A5A] text-center rounded-full'></div> */}
                            <h2 className='text-center w-full text-[29px] font-bold pb-2'>Login Here</h2>
                            <div>
